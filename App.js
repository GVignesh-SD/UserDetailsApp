...
import {Text, View, TextInput, TouchableOpacity, ScrollView, Modal, Image } from 'react-native';
...
export default function App() {
  ...
  const handleTakePhoto = async () => {
    try {
      ...
      if (!result.canceled) {
        ...
        await saveImageToLocal(imagePath);
      }
    } catch (error) {
  ...
  const saveImageToLocal = async (imagePath) => {
    try {
      const fileName = 'myCapturedImage.jpg';
      const destinationUri = FileSystem.documentDirectory + fileName;
  ...
  const searchCountry = useCallback((text) => {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
      ...
      <View className="mx-5 p-2" >
          <Text className="text-center font-bold text-blue-600 text-xl mt-3">
              Form Page
          </Text>
          <View className="my-2">
          ...
          <View className="">
            ...
            <TouchableOpacity className="p-4 my-4 border border-black rounded-md" onPress={() => 
              {
          ...
          <View>
            <TouchableOpacity className="p-5 bg-green-400 rounded-md" onPress={handleTakePhoto}> 
              <Text className="text-center font-bold text-white">Take a Photo</Text>
            </TouchableOpacity>
            {capturedImage && <Image source={{ uri: capturedImage }} className="self-center my-2" style={{ width: 200, height: 200 }} />}
          </View>
          <View className="my-2">
            <TouchableOpacity className="p-5 bg-green-400 rounded-md" onPress={handleRecordVideo}> 
              <Text className="text-center font-bold text-white">Record a Video</Text>
            </TouchableOpacity>
            {capturedVideo   ? (
  <Text>Video is Recorded</Text>
) : (
  <Text>Video is Not Recorded</Text>
)}
          </View>
          {capturedVideo && (
      <View className="my-2">
        <Text className="font-bold text-[18px] text-green-500">Recorded Video:</Text>
        <Video
